...
- Fases: 1=MVP local ✅ · 2=Supabase (projeto PRÓPRIO — nunca reusar o do Parcere; free tier = 2 projetos ativos e o Parcere já usa 1) · 3=paywall R$ 14,90 · 4=Vercel + TWA na Play (`br.com.marcaula.app`; copiar pipeline do Parcere) · 5=lembretes, pacotes, recibos, Google Agenda.
